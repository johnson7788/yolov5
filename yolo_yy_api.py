...
class YOLOModel(object):
    def __init__(self, verbose=0):
        ...
        self.label_list = ['myself', 'friends', 'head_dialogue', 'wing_energy', 'piano_keyboard', 'xiaohei', 'candle', 'chendao_gate', 'yunye_gate', 'yulin_gate', 'xiagu_gate', 'mutu_gate', 'baofengyan_gate', 'task', 'total_candle', 'total_heart', 'total_season_candle', 'total_red_candle', 'setting_button', 'total_dialogue', 'tools_box', 'piano', 'jinge_gate', 'little_boat', 'close_piano']
        self.label_list_cn = self.label_list
        #给每个类别的候选框设置一个颜色
        ...
        #模型的名称或路径
        self.weights = 'runs/train/gy/weights/best.pt'      # 'yolov5s.pt'
